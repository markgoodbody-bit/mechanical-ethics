...
CANDIDATE = Path("MECHANICAL_ETHICS.md")

EXPECTED = {
    CANDIDATE: (87177, "56b09d5a1f7f0db5102ad47a636c60273cd2ddc325d216b4414e5359f21604a7"),
    Path("figures/figure-1-file-and-life.svg"): (3268, "7e925765434bc701d5eacb88972a8f9715bc4a66d548e5b569d9c9a99692c2bb"),
    Path("figures/figure-1-file-and-life.png"): (81671, "bc19a7b7121faba611ef900470398ad5981ae1d1ff44faa79b3912b2a449ec00"),
    Path("figures/figure-2-correction-window.svg"): (2887, "4d1570e07bfb8dcf7a3b9c7fc6cf380f1522e3b49b29fbf78df218be99069a5f"),
    Path("figures/figure-2-correction-window.png"): (58039, "d1df6bea949b7db9bb64fd76fda35921d49473503b920b85ccae83864c445bc3"),
    Path("figures/figure-3-two-flats-one-wall.svg"): (3756, "0d98a7ea605bf9a440f0d315b5ca62fb2c4144d4cedea78bad81cbad5119db11"),
    Path("figures/figure-3-two-flats-one-wall.png"): (69949, "e6e0a457e3e1225edb1b29e0be9e698b988814270578d75ebd381f6bbab928d1"),
    Path("figures/figure-4-machine-speed-human-correction.svg"): (3979, "c17f04eb3d3c22e6b1d62eae7e505ba0bd42e7f6a6c6a76d45d263bdd2e5662a"),
    Path("figures/figure-4-machine-speed-human-correction.png"): (65773, "4d0f41aa5eb560b6afe1b9e2102c99a8476d2c9211a380d6c401192016797ebf"),
    Path("repository/MECHANICAL_ETHICS_HUMAN_READER_v0_6_3.md"): (85831, "162b54711ceb6a5cbba29c120da917d0aa2265b2474ef170c5b6ca01a059d2e0"),
    Path("repository/Mechanical_Ethics_v0_6_3.pdf"): (153784, "e322ed9e420e6b3d25e71aba05d03b3b3c7573d19d0731747f3b3ac3cc197237"),
}
...
def repository_bytes(relative: Path) -> bytes:
    """Read the indexed Git object so text identity is checkout-independent."""
    try:
...
def main() -> int:
    ...
    if candidate_path.is_file():
        text = repository_bytes(CANDIDATE).decode("utf-8")
    ...
    print("- v0.6.3 preservation-baseline identities: exact")
