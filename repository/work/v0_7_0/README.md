# Mechanical Ethics v0.7.0 working surface
...
Superseded and withdrawn reader candidates are preserved in
[`archive/`](archive/). They are not alternative current readers and should not
be sent for review unless the change history itself is under examination.

```text
CURRENT_CANDIDATE != PRESERVATION_BASELINE
EVIDENCE_RECORD != READER
ARCHIVED_CANDIDATE != ALTERNATIVE_CURRENT_VERSION
