...
These examples show the Correction Window Test applied to recognizable systems.

Each example uses the same five checks:
...
- [`full_worksheet_benefits_suspension.md`](full_worksheet_benefits_suspension.md) — **PARTIAL PROTECTION**: a benefits route where formal challenge may exist but hardship timing is decisive.
