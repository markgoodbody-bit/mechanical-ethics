...
A private company uses a proprietary risk score to decide whether a customer receives access to a service.
...
The refused customer carries the consequence.
...
- the offer expires;
- the customer must use a more costly alternative;
- a risk label is retained;
- the refusal is copied to other systems;
...
The classification could change if records showed:

- notice to the affected person;
- the reason or basis for refusal;
- a challenge route;
- timing of review;
- reviewer authority;
- reversal outcomes;
- whether correction reaches downstream records;
- whether correction can happen before the affected person's opportunity closes.

## Minimum repair

A stronger public route would include:

- explanation of the decision basis;
- affected-person access to relevant data;
- challenge route with a deadline;
- reviewer with authority to reverse;
- record correction;
- downstream correction where the score or refusal propagates.
