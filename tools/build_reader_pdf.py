...
if len(sys.argv) != 3:
    print('usage: build_reader_pdf.py input.md output.pdf', file=sys.stderr)
    raise SystemExit(2)
...
for n, (marker, caption) in figs.items():
    ...
    replacement = (
        f'<figure class="diagram figure-{n}">\n'
        f'<img src="{(figdir / f"figure-{n}.svg").as_uri()}" alt="{marker.title()}">\n'
        f'<figcaption>{caption}</figcaption>\n'
        f'</figure>'
    )
    if exact not in text:
        raise SystemExit(f'figure {n} block not found')
...
body {
  font-family: Caladea, 'DejaVu Serif', serif;
  color: #171717;
  line-height: 1.33;
  margin: 0;
  hyphens: none;
...
ul, ol { margin: 2pt 0 7pt 0; padding-left: 1.45em; }
li { margin: 0 0 1.2pt 0; }
li > p { margin: 0; }
blockquote {
  margin: 9pt 0 11pt 0;
  padding: 8pt 12pt 7pt 12pt;
  border-left: 2.5pt solid #b89144;
  background: #f1efeb;
  break-inside: auto;
}
blockquote p { margin-bottom: 7pt; }
...
.contents-line.indent-1 { padding-left: 1.45em; }
...
figure.figure-1 img { width: 75%; }
figure.figure-2 img { width: 85%; }
figure.figure-3 img { width: 90%; }
figure.figure-4 img { width: 90%; }
...
.display.math { display: block; text-align: center; margin: 7pt 0 9pt 0; }
h1 + p, h2 + p, h3 + p { break-before: avoid; }
#sources-and-references ~ p,
#sources-and-references ~ ul { font-size: 9.3pt; }
''', encoding='utf-8')

subprocess.run([
    'pandoc', str(pre_md),
    '--from=markdown+raw_html+raw_tex+tex_math_dollars',
    '--to=html5', '--standalone', '--mathml',
    '--metadata', 'title=Mechanical Ethics: When Correction Arrives Too Late',
    '--metadata', 'subject=Human Reader v0.6.2 - Formal Honesty and Factual Correction Candidate',
...
contents_lines = [
    ('Opening - Let Us Begin with an Entity', 0),('How to Read This Book', 0),('A Timing Condition', 0),
    ('Part I - The Door', 0),('1. A Door You Cannot Reach', 1),('2. Who Builds the Maze', 1),('3. Process Becomes Distance', 1),
    ('Part II - The Clock', 0),('4. Help Before the Loss Sets', 1),('5. The Strategic Unknown', 1),('6. Slow Harm', 1),('Short Case - The Finance Appeal That Arrived Too Late', 1),
    ('Part III - The Witness', 0),('7. When There Is No Enforcer', 1),('8. Custody', 1),('9. Residue', 1),('Interlude - Two Flats, One Wall', 1),
    ('Part IV - The Machine', 0),('Before the Machine - The Predator Position', 1),('10. Who Pays for Complexity', 1),('11. The Second Person', 1),('12. Correction Theatre', 1),('Historical Note - Challenger and the Cost of Proceeding', 1),('The Machine-Speed Brake', 1),
    ('Part V - After the Fall', 0),('13. Peace as Evidence', 1),('14. What Remains Open', 1),('15. A Human Standard for Answerability', 1),
    ('Part VI - Futures Still Reachable', 0),('Interlude - The Saturday Workshop', 1),('16. The Conditions of Hope', 1),('17. Care Without Possession', 1),('18. Kindness as the Placement of Burden', 1),
    ('Conclusion', 0),("Author's Note - How This Began", 0),('Appendix A - Middle-Out Reconstruction Notes', 0),('Appendix B - What Remains Unfinished', 0),('Appendix C - Status, Lineage, Sources, and the Two-Artifact Pair', 0),
]
contents_html = '<section class="contents-page"><h1>Contents</h1><div class="contents-list">' + ''.join(
    f'<div class="contents-line indent-{indent}">{line}</div>' for line, indent in contents_lines
